...
import pickle
#it will compact trained model in one variable
...
#PICKLE HAS 2 TASK: 1.DUMPING AND 2.LOADING
#  1.pickle.dump(model,what name of vairable i need to compress the model)
